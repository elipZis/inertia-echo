...
func NewJsoniterBinder() (this *JsoniterBinder) {
	this = new(JsoniterBinder)
	this.json = jsoniter.ConfigCompatibleWithStandardLibrary
	return this
}

// Bind implements the `Binder#Bind` function.
func (b *JsoniterBinder) Bind(i interface{}, c echo.Context) (err error) {
	req := c.Request()
	...
	case strings.HasPrefix(ctype, echo.MIMEApplicationJSON):
		if err = b.json.NewDecoder(req.Body).Decode(i); err != nil {
...
func (b *JsoniterBinder) bindData(ptr interface{}, data map[string][]string, tag string) error {
