...
var RootView = service.GetEnvOrDefault("INERTIA_ROOT_VIEW", "app.html")

// Get the configured public path from the environment
var PublicPath = service.GetEnvOrDefault("PUBLIC_PATH", "public")
...
func (this *Inertia) Render(component string, props map[string]interface{}) Response {
	return NewResponse(component, service.MergeMaps(this.sharedProps, props), RootView, this.GetVersion())
}
